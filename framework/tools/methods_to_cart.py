...
def get_product_info(response) -> List[Dict]:
    ...
    for item in response_data["items"]:
        ...
        product_info = {"id": product["id"], "productQuantity": item["productQuantity"]}

        extracted_products.append(product_info)
    return extracted_products


def assert_product_to_add_matches_response(
    add_product: List[Dict], expected_product: List[Dict]
):
    ...
    for expected in expected_product:
        ...
        hamcrest_assert_that(
            matching_product["productQuantity"],
            equal_to(expected_quantity),
...
def extract_random_item_detail(response: Response) -> Dict:
    ...
    return {"id": item_id, "productQuantity": product_quantity}
