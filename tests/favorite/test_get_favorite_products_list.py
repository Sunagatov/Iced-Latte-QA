...
from framework.asserts.assert_favorite import assert_id_key_and_its_value_is_not_empty_in_response
...
class TestFavorite:
    ...
    def test_getting_info_about_not_created_favorite_products_list(self, create_authorized_user):
    ...
    def test_getting_info_about_created_favorite_products_list(self, add_product_to_favorite_list):
        with step("Add random product to the favorite list"):
            token, _, = add_product_to_favorite_list
